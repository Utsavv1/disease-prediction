...
sym_des = pd.read_csv("D:/new project/python project/disease-prediction/disease-prediction/data/symtoms_df.csv")
precautions = pd.read_csv("D:/new project/python project/disease-prediction/disease-prediction/data/precautions_df.csv")
workout = pd.read_csv("D:/new project/python project/disease-prediction/disease-prediction/data/workout_df.csv")
description = pd.read_csv("D:/new project/python project/disease-prediction/disease-prediction/data/description.csv")
medications = pd.read_csv('D:/new project/python project/disease-prediction/disease-prediction/data/medications.csv')
diets = pd.read_csv("D:/new project/python project/disease-prediction/disease-prediction/data/diets.csv")

# load model===========================================
svc = pickle.load(open('D:/new project/python project/disease-prediction/disease-prediction/model/svc.pkl','rb'))
...
def home():
    if request.method == 'POST':
        ...
        symptoms = request.form.get('symptomsInput', '').strip()

        if not symptoms:
            message = "Please enter symptoms to get predictions."
            return render_template('index.html', message=message)

        # Clean up symptoms and validate
