...
sym_des = pd.read_csv("D:/utsav1/prediction/Medicine-Recommendation-System-Personalized-Medical-Recommendation-System-with-Machine-Learning/data/symtoms_df.csv")
precautions = pd.read_csv("D:/utsav1/prediction/Medicine-Recommendation-System-Personalized-Medical-Recommendation-System-with-Machine-Learning/data/precautions_df.csv")
workout = pd.read_csv("D:/utsav1/prediction/Medicine-Recommendation-System-Personalized-Medical-Recommendation-System-with-Machine-Learning/workout_df.csv")
description = pd.read_csv("D:/utsav1/prediction/Medicine-Recommendation-System-Personalized-Medical-Recommendation-System-with-Machine-Learning/data/description.csv")
medications = pd.read_csv('D:/utsav1/prediction/Medicine-Recommendation-System-Personalized-Medical-Recommendation-System-with-Machine-Learning/data/medications.csv')
diets = pd.read_csv("D:/utsav1/prediction/Medicine-Recommendation-System-Personalized-Medical-Recommendation-System-with-Machine-Learning/data/diets.csv")

# load model===========================================
svc = pickle.load(open('D:/utsav1/prediction/Medicine-Recommendation-System-Personalized-Medical-Recommendation-System-with-Machine-Learning/model/xgboost_model.pkl','rb'))
...
def helper(dis):
    """
    Fetch details like description, precautions, medications, diet, and workout for a disease.
    """
